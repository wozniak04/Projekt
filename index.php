		...
		<main class="wrapper">
			...
			<div class="i">
				<div class="specjalisci spec_wrap" id="specjalisci">
                    <!-- opisy specjalistów i ich zdjecia -->
                    <div class="opis1">
                    <h3>Arkadiusz Guth</h3></br> 
                    Chirurg, obecnie przyjmuje pacjentów w Elektryku w Wejherowie. Specjalizuje się w chirurgi plastycznej oraz klatki piersiowej. 
                    Ukończył Pomorski Uniwersytet Medyczny w Szczecinie.
                    </div>
                    <div class="zdj1"></div> 
                    <div class="opis2">
                    <h3>Mikołaj Woźniak</h3></br>
                    Neurolog, obecnie  przyjmuje pacjentów w Elektryku w Wejherowie. Specjalizuje się w leczeniu chorób obwodowego i ośrodkowego 
                    układu nerwowego, specjalizuje się również z zakresu psychiatrii. Ukończył Uniwersytet Mikołaja Kopernika w Toruniu.
                    </div>
                    <div class="zdj2"></div>
                    <div class="opis3">
                    <h3>Kacper Paszki</h3></br>
                    Laryngolog, obecnie  przyjmuje pacjentów w Elektryku w Wejherowie. Specjalizuje się w wykonywaniu zabiegów chirurgicznych w 
			...
			<div class="p">
				<!-- stopka -->
                <!-- fb -->
                <a class="audi-footer__social-media-link" href="http://www.facebook.com/" target="_blank"><svg width="36px" height="36px" class="social-media">
                ...
                <!-- insta -->
                <a class="audi-footer__social-media-link" href="http://instagram.com/" target="_blank"><svg width="36px" height="36px" class="social-media">
							<g fill="currentColor">
